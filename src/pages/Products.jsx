...
function Products() {
    ...
    useEffect(() => {
        ...
        if(searchParms.get('search') || searchParms.get('category') || searchParms.get('company') || searchParms.get('order') || searchParms.get('price') || searchParms.get('shipping')){
            setFilter( prev =>{
                return {
                ...
                price: searchParms.get('price') ? searchParms.get('price') : '100000',
    ...
    return (
        <div className="container mx-auto px-40">
            <form className='grid grid-cols-4 gap-4 mt-10 bg-blue-100 p-5 pb-5 rounded-lg'>
                ...
                <div className='flex flex-col gap-2'>
                    <label>Select price: <b>${filter.price}</b></label>
                    <input
                        value={filter.price}
